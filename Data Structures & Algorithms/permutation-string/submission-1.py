class Solution:
    def checkInclusion(self, s1: str, s2: str) -> bool:
        ...
        for i in range(n1,n2):
            ...
            ord_char_index=ord(s2[i-n1])-ord('a')
            s2_freq[ord_char_index]-=1
            if s2_freq[ord_char_index]==s1_freq[ord_char_index]:
                matches+=1
            elif s1_freq[ord_char_index]==s2_freq[ord_char_index]+1:
                matches-=1
